...
describe('#289 cross-tab reconciliation',()=>{
  it('a stale tab merges newer cross-tab records instead of overwriting them',async ()=>{
    ...
    assert.equal(await tab.persist(),true);
  ...
  it('without external writes the persist path is unchanged',async ()=>{
    const tab=loadTab({version:1,savedAt:100,completed:[W1],templates:[],archivedPrograms:[],customExercises:[],tags:[],exerciseTagPresets:[],favorites:[]});
    await tab.restore();
  ...
  it('an id conflict keeps the newer (external) record version',async ()=>{
    const tab=loadTab({version:1,savedAt:100,completed:[W1],templates:[],archivedPrograms:[],customExercises:[],tags:[],exerciseTagPresets:[],favorites:[]});
    await tab.restore();
  ...
  it('does not re-merge the same external blob twice',async ()=>{
    const tab=loadTab({version:1,savedAt:100,completed:[W1],templates:[],archivedPrograms:[],customExercises:[],tags:[],exerciseTagPresets:[],favorites:[]});
    await tab.restore();
    tab.externalWrite({version:1,savedAt:200,completed:[W1,W2],templates:[],archivedPrograms:[],customExercises:[],tags:[],exerciseTagPresets:[],favorites:[]});
    await tab.persist();
  ...
  it('templates and custom exercises union by id too',async ()=>{
